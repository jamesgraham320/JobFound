...
company1 = Company.create(name: "evil corporation", address: "123 Sesame Street", application: app1)
company2 = Company.create(name: "good corporation", address: "11 Broadway", application: app2)
...
stage1 = Stage.create(application: app1, active: true, name: "submitted", start: DateTime.now, end: DateTime.now)
